...
export function registerStreamableMcp(app, bridge, _progressHub, config) {
    ...
    function createServerInstance() {
        const server = new Server({
            ...
            instructions: 'Automation bridge for Perform3D v10 tutorial pipeline (units kN/cm). Tools mirror the documented workflow.',
        });
